...
public class IDLList<E> {
    ...
    public static void main (String[] args){
        ...
        IDLList<String> dllEmpty= new IDLList<String>();
        IDLList<String> dllSmall = new IDLList<String>();
        ...
        Node<String> node7 = new Node<String>("Node 7");
        Node<String> node8 = new Node<String>("Node 8");
        Node<String> node9 = new Node<String>("Node 9");
       //StarTrek Voyager Characters
        ...
        //Test toString
        System.out.println("dll toString: " +dll.toString());
        //Testing toString on dllSmall
        System.out.println("dllSmall toString" + dllSmall.toString());
        //testing toString on DllEmpty()
        System.out.println("dllEmpty toString" + dllEmpty.toString());
        ...
        //Testing getHead on empty list
        System.out.println("getHead Empty" + dllEmpty.getHead());
        ...
        //Testing getLast on DLlSmall 
        System.out.println("getLast Small" + dllSmall.getLast());

        //Testing getLast on Empty list
        System.out.println("getLast Empty" + dllEmpty.getLast());

        //Testing append
        System.out.println("DLL before append: " + dll);
        ...
        //Testing append with Empty list
        System.out.println("Empty Size: " + dllEmpty.size());
        System.out.println("append Empty: " + dllEmpty.append(JaneWay));
        System.out.println("Empty after append: " + dllEmpty);
        System.out.println("Size dllEmpty After: " + dllEmpty.size());
        ...
        //Testing Remove() with empyy dll
        System.out.println("Remove Empty: " + dllEmpty.remove());
            ...
            while(currentNode != null){
                ...
                //tempNode = currentNode.next;
                    if (currentNode == null){
                        ...
                        this.tail = tempNode; //currentNode.prev;
                        //return currentNode
                        return this.tail.data; //currentNode.data;
                        }
                }
            }
    ...
    public boolean append(E elem){
        ...
        if (this.head == null && this.tail == null){
            ...
            this.head = newNode;
            //assign this head next to tail
            this.head.next = this.tail;
            //update this.tail.prec
        ...
        try {
        //add elem to indices
        this.indices.add(indices.size()-1, this.tail);
        } catch (IndexOutOfBoundsException e) {
            this.indices.add(0, this.tail);
        }
        //update size
        this.size= this.indices.size();
    }
